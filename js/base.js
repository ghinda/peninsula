...
/* Peninsula Unofficial 2013
 * 2013 Ionut Colceriu - ghinda.net
 */
 
/* Get favorites from localStorage */
var starredArtists = window.localStorage.getItem('starredArtists');
...
var starArtist = function(e) {
	...
	// update localStorage
	window.localStorage.setItem('starredArtists', JSON.stringify(starredArtists));
};
